...
SECRET_KEY = "django-insecure-8tzlx*f#1-0vs&p1vx%a7p(6%d75^rno@9(ajuhe!y-pk)ei-g"
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ["https://*.apps.ocp.pgustafs.com"]

# Application definition

INSTALLED_APPS = [
    "base.polls.apps.PollsConfig",
